							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h3 class="product-name"><a href="#"> Laptop Gamink</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Headset jedag jedug</a></h3>
										<h4 class="product-price">$5.99 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Laptop bukan gaming</a></h3>
										<h4 class="product-price">$48.99 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#"> Tab </a></h3>
										<h4 class="product-price">$499.00 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">$90.99 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Lappy bagus</a></h3>
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">HP</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Lappy</a></h3>
										<h4 class="product-price">$980.00 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">iPod</a></h3>
										<h4 class="product-price">$499.00 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
						...
						<div class="products-widget-slick" data-nav="#slick-nav-5">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Ini LAPTOP</a></h3>
										<h4 class="product-price">$899.00 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">ini HP</a></h3>
										<h4 class="product-price">$212.12 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Mi PAD 2</a></h3>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Headset warnet</a></h3>
										<h4 class="product-price">$100 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">Laptop militer</a></h3>
										<h4 class="product-price">$499.00 <del class="product-old-price">$990.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
