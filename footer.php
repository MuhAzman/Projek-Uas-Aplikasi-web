						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Sleman, DIY</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+6281255046147</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>asmanboy188@gmail.com</a></li>
								</ul>
							</div>
						</div>
